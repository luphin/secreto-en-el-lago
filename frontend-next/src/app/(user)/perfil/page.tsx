    ...
    <Box minH="100vh" bg="bg.canvas">
      ...
      <Container maxW="container.md">
        <VStack align="stretch" gap={6}>
          ...
          <Card.Root p={8}>
            <VStack align="stretch" gap={6}>
              <Heading size="lg" mb={2}>Foto de perfil y biometría</Heading>

              <HStack gap={6} align="start">
                {/* Avatar */}
                <VStack gap={3}>
                  <Avatar.Root size="2xl">
                    <Avatar.Image src={profileImage || user?.foto_url} />
                    <Avatar.Fallback>
                  ...
                  <label htmlFor="profile-image-upload" style={{ cursor: "pointer" }}>
                    <Button as="span" colorPalette="blue" variant="outline" size="sm">
                      <LuCamera />
                      Cambiar foto
                    </Button>
                  </label>
                ...
                <VStack flex={1} align="stretch" gap={4}>
                  ...
                  <Button colorPalette="blue" onClick={handleFingerprintClick} size="lg">
                    <LuFingerprint />
          ...
          >
            ...
            <Dialog.Positioner>
              <Dialog.Content maxW="sm" borderRadius="lg">
                <Dialog.Header>
                  <Dialog.Title>Conectando con el lector</Dialog.Title>
                  <Dialog.CloseTrigger />
                </Dialog.Header>

                <Dialog.Body>
                  <VStack gap={6} py={8} align="center" textAlign="center">
                    <Spinner size="xl" color="blue.600" />

                    <VStack gap={2}>
                      <Text fontSize="lg" fontWeight="semibold">
                        Inicializando el dispositivo biométrico...
                      </Text>

                      <Text fontSize="sm" color="gray.600" lineHeight="1.6">
                        Esto tomará unos segundos mientras establecemos la comunicación
